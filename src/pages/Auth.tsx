          ...
          <div className="bg-card rounded-2xl p-6 md:p-8 shadow-card">
            ...
            {registrationSuccess ? (
              ...
              >
                ...
                <p className="font-semibold text-foreground bg-muted px-4 py-2 rounded-lg inline-block mb-6">
                  {registeredEmail}
                </p>
                <Alert className="text-left mb-6 border-amber-500/50 bg-amber-50 dark:bg-amber-900/20">
                  <Mail className="h-4 w-4 text-amber-600" />
                  <AlertTitle className="text-amber-800 dark:text-amber-200">Verifica tu correo electrónico</AlertTitle>
                  <AlertDescription className="text-amber-700 dark:text-amber-300">
                    Para poder iniciar sesión, debes hacer clic en el enlace de verificación que te enviamos. 
                  ...
                  <TabsContent value="login">
                    {emailNotConfirmedError && (
                      <Alert className="mb-4 border-amber-500/50 bg-amber-50 dark:bg-amber-900/20">
                        ...
                        <AlertTitle className="text-amber-800 dark:text-amber-200">Email no verificado</AlertTitle>
                        <AlertDescription className="text-amber-700 dark:text-amber-300">
                          Tu cuenta existe pero aún no has verificado tu correo electrónico. 
